...
<ul class="navbar">
    ...
    <li class="dropdown">
        ...
        <div class="dropdown-content">
            <a href='#' onclick='CaricaEventi.loadData(CaricaEventi.ACCOUNT_UTENTE)'>Account</a>
            <a href='#' onclick='CaricaEventi.loadData(CaricaEventi.EVENTI_INTERESSE_UTENTE)'>Eventi d'interesse</a>
            <a href='#' onclick='CaricaEventi.loadData(CaricaEventi.EVENTI_PARTECIPAZIONI_UTENTE)'>Partecipazioni</a>
            <a href='#' onclick='CaricaEventi.loadData(CaricaEventi.EVENTI_CREATI_UTENTE)'>Eventi creati</a>
            <a>Logout</a>
        </div>
    </li>
